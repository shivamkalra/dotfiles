...
tags = {
   ...
   layout = { layouts[2], layouts[2], layouts[3], layouts[2], layouts[1], layouts[2], layouts[2], layouts[1], layouts[1]}
}
...
for s = 1, screen.count() do
   ...
   -- Create the wibox
   mywibox[s] = awful.wibox({ position = "top", screen = s, s, height = 20 })
